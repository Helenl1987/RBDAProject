...
parser.add_argument("-as", "--aspect-size", dest="aspect_size", type=int, metavar='<int>', default=20, help="The number of aspects specified by users (default=14)")
